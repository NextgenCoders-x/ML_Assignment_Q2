"""
create_notebook_p2.py
=====================
Generates Part2_ML.ipynb using nbformat, mirroring part2_ml.py logic.
"""
...
cells.append(nbf.v4.new_markdown_cell(
    ...
    "\n"
    "This notebook builds on the cleaned dataset from Part 1 and implements:\n"
...
# ── 3. Step 1 markdown ──────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 1: Load Cleaned Dataset"))
...
# ── 5. Step 2 markdown ──────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 2: Define Feature Matrix and Targets"))

# ── 6. Define targets code ──────────────────────────────────────
cells.append(nbf.v4.new_code_cell(
    "# Regression target: TotalMarks\n"
    "y_reg = df['TotalMarks'].copy()\n"
    "print(f'Regression target (y_reg): TotalMarks')\n"
...
# ── 7. Step 3 markdown ──────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 3: Encoding Categorical Columns"))
...
# ── 9. Step 4 markdown ──────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 4: Train/Test Split"))

# ── 10. Train/test split code ───────────────────────────────────
cells.append(nbf.v4.new_code_cell(
...
# ── 11. Step 5 markdown ─────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 5: Feature Scaling"))

# ── 12. Feature scaling code ────────────────────────────────────
cells.append(nbf.v4.new_code_cell(
...
# ── 13. Step 6 markdown ─────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 6: Linear Regression"))

# ── 14. Linear regression code ──────────────────────────────────
cells.append(nbf.v4.new_code_cell(
    "lr = LinearRegression()\n"
...
# ── 15. Step 7 markdown ─────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 7: Ridge Regression"))

# ── 16. Ridge regression code ───────────────────────────────────
cells.append(nbf.v4.new_code_cell(
...
# ── 17. Step 8 markdown ─────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 8: Class Imbalance Check"))

# ── 18. Class imbalance code ────────────────────────────────────
cells.append(nbf.v4.new_code_cell(
...
# ── 19. Step 9 markdown ─────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 9: Logistic Regression (C=1.0)"))

# ── 20. Logistic regression code ────────────────────────────────
cells.append(nbf.v4.new_code_cell(
...
# ── 21. Step 10 markdown ────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 10: Classification Evaluation"))

# ── 22. Classification evaluation code ──────────────────────────
cells.append(nbf.v4.new_code_cell(
    "# Confusion Matrix\n"
...
# ── 23. Step 11 markdown ────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 11: ROC Curve"))
...
# ── 25. Step 12 markdown ────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 12: Threshold Sensitivity Analysis"))

# ── 26. Threshold analysis code ─────────────────────────────────
cells.append(nbf.v4.new_code_cell(
...
# ── 27. Step 13 markdown ────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 13: Regularization Experiment"))

# ── 28. Regularization experiment code ──────────────────────────
cells.append(nbf.v4.new_code_cell(
    ...
    "\n"
    "print(f'--- Logistic Regression (C=0.01) Results ---')\n"
...
# ── 29. Step 14 markdown ────────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell("## Step 14: Bootstrap Confidence Interval"))

# ── 30. Bootstrap CI code ───────────────────────────────────────
cells.append(nbf.v4.new_code_cell(
    "np.random.seed(42)\n"
    "n_bootstrap = 500\n"
    "auc_diffs = []\n"
...
# ── 31. Conclusion markdown ─────────────────────────────────────
cells.append(nbf.v4.new_markdown_cell(
    "## Conclusion\n"
    "\n"
    "In this notebook we completed the full ML pipeline:\n"
    "\n"
    "- **Regression**: Trained Linear Regression and Ridge Regression models to predict TotalMarks. "
    "Compared MSE and R2 scores to assess the impact of L2 regularization.\n"
    "- **Classification**: Built Logistic Regression to classify students as above/below median marks. "
    "Evaluated with confusion matrix, accuracy, precision, recall, F1, and AUC.\n"
    "- **ROC Curve**: Visualized the trade-off between true positive rate and false positive rate.\n"
    "- **Threshold Analysis**: Explored how different classification thresholds affect precision, recall, and F1.\n"
    "- **Regularization Experiment**: Compared C=1.0 vs C=0.01 to see the effect of stronger regularization.\n"
    "- **Bootstrap CI**: Used 500 bootstrap samples to construct a 95% confidence interval for the AUC difference "
    "between the two regularization settings.\n"
    "\n"
    "All results and plots have been saved to the `images/` directory."
))

nb.cells = cells

# Write the notebook
out_path = "Part2_ML.ipynb"
